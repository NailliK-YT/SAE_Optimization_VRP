...
/**
 * Chargement des fichiers de donnees (.txt et .dat)
 */
public class ChargeurFichier {
    ...
    public static DonneesVRP lireFichierTxt(String nomFichier) throws IOException {
        ...
        int nbVehicules = (int) (1.5 * Arrays.stream(demandes).sum() / donnees.getCapaciteVehicule()) + 2;
        if (nbVehicules < 5)
            nbVehicules = 10;
    ...
    public static DonneesVRP lireFichierDat(String nomFichier) throws IOException {
        ...
        if (donnees.getNbClients() == 0 || donnees.getNbVehicules() == 0 || donnees.getCapaciteVehicule() == 0) {
    ...
    private static int[] extraireTableauEntiers(BufferedReader reader, String premiereLigne) throws IOException {
    ...
    private static double[][] extraireMatrice(BufferedReader reader, String premiereLigne) throws IOException {
